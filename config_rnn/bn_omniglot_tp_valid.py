...
rng_valid = np.random.RandomState(24)
...
train_data_iter = data_iter.OmniglotExchSeqDataIterator(seq_len=seq_len, batch_size=batch_size,
                                                        set='train', rng=rng, augment=True, valid_split=True)

valid_data_iter = data_iter.OmniglotExchSeqDataIterator(seq_len=seq_len, batch_size=batch_size, set='valid',
                                                        valid_split=True,
                                                        augment=False, rng=rng_valid)
